  ...
  <van-cell class="comment-item">
    ...
    <div slot="label">
      ...
      <div class="bottom-info">
        ...
        <van-button class="reply-btn" round size="small"  @click="$emit('onReply-Click',commentsData)"
          >回复{{ this.commentsData.reply_count }}</van-button
        >
      </div>
    </div>
  </van-cell>
      ...
      try {
        ...
        if (this.commentsData.is_liking) {
          ...
          await delCommentLike({
            ...
            type: this.commentsData.type
          })
          // this.commentsData.is_liking = !this.commentsData.is_liking
          // this.commentsData.like_count--
          this.$toast('取消点赞')
        } else {
